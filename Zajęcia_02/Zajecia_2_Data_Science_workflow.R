#2. CZĘŚĆ II: Minimalny workflow analityczny pracy z danymi----
# 
...
#2.1.1. Prawidłowy import plików CSV z folderu - wykonaj: ----
...
#2.1.2. PAKIETY W R - rozszerzenie możliwości ----
...
#2.2.2. Porządkowanie nazw kolumn (zmiennych) ----
...
#2.2.3. Porządkowanie typów danych ----
...
#2.2.3. Porządkowanie braków danych ----
...
#2.4.1. Najczęściej używane funkcje pakietu dplyr: ----
...
#2.4.1.1. mutate() – tworzenie nowych zmiennych na bazie istniejących ----
...
#2.4.1.2. filter() – wybieranie wierszy ----
#2.4.1.3. select() – wybieranie kolumn ----
...
#2.4.1.5. group_by() – grupowanie ----
#2.4.1.6. summarise() - obliczanie wartości zagregowanych (np. średnich, sum) ----
...
# 2.5.1. Prosty wykres punktowy: urbanizacja a PKB per capita ----
...
# 2.5.2. Zaawansowany wykres punktowy: urbanizacja a PKB per capita ----
...
# 2.5.3. Zaawansowany wykres punktowy: rozmiar gospodarki a populacja ----
...
# 2.5.4. Prosty wykres słupkowy: liczba krajów w regionach ----
...
# 2.5.5. Zaawansowany wykres słupkowy poziomy: TOP 15 najbogatszych krajów ----
kraje %>%
  arrange(desc(PKB_per_capita)) %>%
  head(15) %>%
...
# 2.5.6. Wykres pudełkowy (boxplot): dostęp do internetu według regionów ----
...
# 2.5.7. Wykres pudełkowy (boxplot): przyrost populacji według regionów ----
